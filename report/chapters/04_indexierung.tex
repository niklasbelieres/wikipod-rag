...
Für den Bulk-Indexiervorgang (\texttt{index\_chunks()}) wird jedem Chunk als OpenSearch-Dokument-\texttt{\_id} die deterministische \texttt{chunk\_id} 
zugewiesen statt einer automatisch generierten ID. Ein wiederholter Indexierlauf überschreibt so bestehende Dokumente, statt Duplikate anzulegen, was 
praktisch für wiederholte Testläufe ist. \texttt{create\_index()} legt den Index nur an, wenn er noch nicht existiert; ein \texttt{recreate}-Flag 
