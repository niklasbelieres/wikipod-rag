...
\usepackage{tikz}\usetikzlibrary{arrows.meta,positioning,fit,shapes.geometric,backgrounds}
\graphicspath{{images/}}
...
\include{chapters/02_architektur}
\include{chapters/03_dokumentenauswahl}
\include{chapters/04_indexierung}
\include{chapters/05_rag_pipeline}
\include{chapters/06_deployment}
\include{chapters/07_evaluation}
\include{chapters/08_anleitung}
\include{chapters/09_diskussion}
\include{chapters/10_fazit}

\printbibliography

\appendix
\include{chapters/a1_anhang}
